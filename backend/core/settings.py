...
MIDDLEWARE = [
    ...
    'core.middleware.SecurityHeadersMiddleware',  # Custom middleware for OAuth
...
# Using in-memory channel layer for development (single-server only)
CHANNEL_LAYERS = {
    'default': {
...
# For production with Redis 5.0+, use:
# CHANNEL_LAYERS = {
#     'default': {
...
# X-Frame Options for OAuth popups
